...
const types = {
	...
	randrot: {
		color: "#ee7777", children: ["message"], label: el => (
			...
			: "Randomize"),
		params: [{attr: "mode", label: "Mode", values: ["random", "rotate", "switch"], selections: {random: "Random", rotate: "Rotate", switch: "Switch"}},
			...
			{attr: "switchon", label: "Switch on"}],
		typedesc: ["Each time this is triggered, pick one child and show it. Rotation can specify a",
			BR(), "synchronization tag so multiple commands can rotate together. Switching on some",
