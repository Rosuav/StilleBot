...
const types = {
	...
	rotate: {
		color: "#ee7777", children: ["message"], label: el => "Rotate",
		params: [{attr: "mode", label: "Rotate", values: "rotate"},
			{attr: "rotatename", label: "Tag (optional)", values: cooldown_name}], //Reuses the cooldown_name handler to hide any autogenerated ones
		typedesc: "Each time this is triggered, pick the next child and show it",
	},
	text: {
